...
INSERT INTO employee (account_id, person_id, role)
...
$$
    DECLARE
        ...
        v_changer_id  BIGINT;
    BEGIN
        v_material_id := (SELECT id FROM material WHERE name = 'Фанера 4мм');
        v_changer_id := (SELECT id FROM account WHERE username = 'supply_manager1');

        CALL p_update_material_balance_and_set_current(v_material_id, 100.00, v_changer_id);
    END
$$;
...
$$
    DECLARE
        ...
        v_changer_id  BIGINT;
    BEGIN
        v_material_id := (SELECT id
                          FROM material
                          WHERE name = 'Картон упаковочный');

        v_changer_id := (SELECT id
                         FROM account
                         WHERE username = 'supply_manager1');

        CALL p_update_material_balance_and_set_current(v_material_id, 200.00, v_changer_id);
    END
$$;
...
$$
    ...
    BEGIN
        v_file_id := (SELECT id
                      FROM file
                      WHERE filename = 'keychain_photo.jpg');

        v_owner_id := (SELECT id
                       FROM account
                       WHERE username = 'sales_manager');
...
INSERT INTO email_token (token, account_id, expiration_dt)
...
WHERE id = (SELECT account_id FROM client WHERE email = 'client1@example.com')
  AND EXISTS (SELECT 1
              ...
              WHERE et.token = 'ABC123CONFIRM'
                AND et.account_id = (SELECT id FROM client WHERE email = 'client1@example.com')
...
$$
    ...
    BEGIN
        v_file_id := (SELECT id
                      FROM file
                      WHERE filename = 'client_sketch.dxf');

        v_owner_id := (SELECT account_id
                       FROM client
...
$$
    ...
    BEGIN
        ...
        CALL p_update_client_order_status_and_set_current(v_order_id, 'CREATED');
    END
$$;
...
$$
    ...
    BEGIN
        ...
        CALL p_update_client_order_status_and_set_current(v_order_id, 'IN_PROGRESS');
    END
$$;
...
$$
    ...
    BEGIN
        v_file_id := (SELECT id
                      FROM file
                      WHERE filename = 'keychain_model.step');
...
$$
    ...
    BEGIN
        v_file_id := (SELECT id
                      FROM file
                      WHERE filename = 'keychain_bom.xlsx');
...
$$
    ...
    BEGIN
        ...
        CALL p_update_client_order_status_and_set_current(v_order_id, 'PENDING_APPROVAL');
    END
$$;
...
$$
    ...
    BEGIN
        ...
        CALL p_update_client_order_status_and_set_current(v_order_id, 'REWORK');
    END
$$;
...
$$
    ...
    BEGIN
        ...
        CALL p_update_client_order_status_and_set_current(v_order_id, 'APPROVED');
    END
$$;
...
$$
    ...
    BEGIN
        ...
        CALL p_update_client_order_status_and_set_current(v_order_id, 'AWAITING_PAYMENT');
    END
$$;
...
$$
    ...
    BEGIN
        ...
        CALL p_update_client_order_status_and_set_current(v_order_id, 'PAID');
    END
$$;
...
$$
    ...
    BEGIN
        v_file_id := (SELECT id
                      FROM file
                      WHERE filename = 'keychain_nc_program.nc');
...
$$
    ...
    BEGIN
        ...
        CALL p_update_client_order_status_and_set_current(v_order_id, 'READY_FOR_PRODUCTION');
    END
$$;
...
$$
    ...
    BEGIN
        ...
        CALL p_update_production_task_status_and_set_current(v_task_id, 'QUEUED');
    END
$$;
...
$$
    ...
    BEGIN
        ...
        CALL p_update_production_task_status_and_set_current(v_task_id, 'IN_PROGRESS');
    END
$$;
...
$$
    ...
    BEGIN
        ...
        CALL p_update_client_order_status_and_set_current(v_order_id, 'IN_PRODUCTION');
    END
$$;
...
$$
    ...
    BEGIN
        ...
        CALL p_update_production_task_status_and_set_current(v_task_id, 'COMPLETED');
    END
$$;
...
$$
    ...
    BEGIN
        v_material_id := (SELECT id
                          FROM material
                          WHERE name = 'Фанера 4мм');

        v_new_balance := (SELECT mb.balance - 0.50
                          FROM material m
        ...
        v_changer_id := (SELECT id
                         FROM account
                         WHERE username = 'cnc_operator1');

        CALL p_update_material_balance_and_set_current(v_material_id, v_new_balance, v_changer_id);
    END
$$;
...
$$
    ...
    BEGIN
        ...
        v_new_balance := (SELECT mb.balance - 10.00
                          FROM material m
                                   JOIN material_balance mb ON m.current_balance_id = mb.id
...
$$
    ...
    BEGIN
        ...
        CALL p_update_client_order_status_and_set_current(v_order_id, 'COMPLETED');
    END
$$;
...
$$
    ...
    BEGIN
        ...
        CALL p_update_purchase_order_status_and_set_current(v_po_id, 'CREATED');
    END
$$;
...
$$
    ...
    BEGIN
        ...
        v_new_balance := (SELECT mb.balance + 50.00
                          FROM material m
                                   JOIN material_balance mb ON m.current_balance_id = mb.id
                          WHERE m.name = 'Фанера 4мм');
...
$$
    ...
    BEGIN
        ...
        CALL p_update_purchase_order_status_and_set_current(v_po_id, 'COMPLETED');
    END
$$;
